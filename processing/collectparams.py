...
class CollectCredentialsParams:
    ...
    def load_s3_credentils(self):
        ...
        try:
            ...
            print('Could not update the S3 credentils from s3. '
                  'Default credentils will be used.')
    ...
    def load_fb_params(self):
        ...
        try:
            ...
            print('Could not update the params from s3. '
    ...
    def load_fb_fields(self):
        ...
        try:
            ...
            print('Could not update the fields from s3. '
                  'Default fields will be used.')
    ...
    def process_params(self):
        ...
        for breakdown in params:
            ...
            if param['time_range'].lower() == 'yesterday':
                v = 1
            elif param['time_range'].lower() == 'last_1_days':
                v = 1
            elif param['time_range'].lower() == 'last_2_days':
                v = 2
            elif param['time_range'].lower() == 'last_3_days':
                v = 3
            elif param['time_range'].lower() == 'last_4_days':
                v = 4
            elif param['time_range'].lower() == 'last_5_days':
                v = 5
            elif param['time_range'].lower() == 'last_6_days':
                v = 6
            elif param['time_range'].lower() == 'last_7_days':
                v = 7
            else:
                print('time_range must be one of these - '
                      'yesterday, last_1_days through or last_7_days')
                return None
            ...
            for i in range(v):
                ...
                outfile = 'fb_breakdown_'
                outfile += str(breakdown).lower().replace(' ', '')
                outfile += f'_{str(TODAY - datetime.timedelta(days=i + 1))}'
                outfile += f'-{str(TODAY - datetime.timedelta(days=i + 1))}'
                outfile += '.csv'
